...
func (uc *UserCreate) SetDefaultShippingAddressID(s string) *UserCreate {
	uc.mutation.SetDefaultShippingAddressID(s)
	return uc
}

// SetDefaultBillingAddressID sets the "default_billing_address_id" field.
func (uc *UserCreate) SetDefaultBillingAddressID(s string) *UserCreate {
	uc.mutation.SetDefaultBillingAddressID(s)
	return uc
}
...
func (uc *UserCreate) check() error {
	if _, ok := uc.mutation.DefaultShippingAddressID(); !ok {
		return &ValidationError{Name: "default_shipping_address_id", err: errors.New(`ent: missing required field "User.default_shipping_address_id"`)}
	}
	if _, ok := uc.mutation.DefaultBillingAddressID(); !ok {
		return &ValidationError{Name: "default_billing_address_id", err: errors.New(`ent: missing required field "User.default_billing_address_id"`)}
	}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.DefaultShippingAddressID(); ok {
		_spec.SetField(user.FieldDefaultShippingAddressID, field.TypeString, value)
		_node.DefaultShippingAddressID = value
	}
	if value, ok := uc.mutation.DefaultBillingAddressID(); ok {
		_spec.SetField(user.FieldDefaultBillingAddressID, field.TypeString, value)
		_node.DefaultBillingAddressID = value
	}
