...
var file_profile_proto_depIdxs = []int32{
	1, // 0: pb.Profile.birthdate:type_name -> google.protobuf.Timestamp
	2, // 1: pb.Profile.gender:type_name -> pb.Gender
	1, // 2: pb.Profile.created_at:type_name -> google.protobuf.Timestamp
	1, // 3: pb.Profile.updated_at:type_name -> google.protobuf.Timestamp
