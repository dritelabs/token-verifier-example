...
import * as drite_account_v1_account_pb from "./account_pb";
import * as drite_account_v1_client_pb from "./client_pb";
import * as drite_account_v1_jwk_pb from "./jwk_pb";
import * as drite_account_v1_user_pb from "./user_pb";
import * as google_protobuf_empty_pb from "google-protobuf/google/protobuf/empty_pb";
import * as google_protobuf_any_pb from "google-protobuf/google/protobuf/any_pb";

interface IAccountServiceService
...
interface IAccountServiceService_IAuthenticateUser
  extends grpc.MethodDefinition<
    drite_account_v1_user_pb.AuthenticateUserRequest,
    drite_account_v1_user_pb.AuthenticateUserResponse
  > {
...
interface IAccountServiceService_ICreateClient
  extends grpc.MethodDefinition<
    drite_account_v1_client_pb.CreateClientRequest,
...
interface IAccountServiceService_ICreateUser
  extends grpc.MethodDefinition<
    drite_account_v1_user_pb.CreateUserRequest,
    drite_account_v1_user_pb.User
  > {
...
interface IAccountServiceService_IDeleteClient
  extends grpc.MethodDefinition<
    drite_account_v1_client_pb.DeleteClientRequest,
...
interface IAccountServiceService_IDeleteUser
  extends grpc.MethodDefinition<
    drite_account_v1_user_pb.DeleteUserRequest,
    google_protobuf_empty_pb.Empty
  > {
...
interface IAccountServiceService_IGetClient
  extends grpc.MethodDefinition<
    drite_account_v1_client_pb.GetClientRequest,
    drite_account_v1_client_pb.Client
  > {
...
interface IAccountServiceService_IGetJwks
  extends grpc.MethodDefinition<
    drite_account_v1_jwk_pb.GetJwksRequest,
...
interface IAccountServiceService_IGetUser
  extends grpc.MethodDefinition<
    drite_account_v1_user_pb.GetUserRequest,
    drite_account_v1_user_pb.User
  > {
...
interface IAccountServiceService_IListClients
  extends grpc.MethodDefinition<
    drite_account_v1_client_pb.ListClientsRequest,
    drite_account_v1_client_pb.ListClientsResponse
  > {
...
interface IAccountServiceService_IListUsers
  extends grpc.MethodDefinition<
    drite_account_v1_user_pb.ListUsersRequest,
    drite_account_v1_user_pb.ListUsersResponse
  > {
...
interface IAccountServiceService_IUpdateUser
  extends grpc.MethodDefinition<
    drite_account_v1_user_pb.UpdateUserRequest,
    drite_account_v1_user_pb.User
  > {
...
export interface IAccountServiceServer
  ...
  createUser: grpc.handleUnaryCall<
    ...
    drite_account_v1_user_pb.User
  >;
  deleteClient: grpc.handleUnaryCall<
    drite_account_v1_client_pb.DeleteClientRequest,
    google_protobuf_empty_pb.Empty
  >;
  deleteUser: grpc.handleUnaryCall<
    ...
    google_protobuf_empty_pb.Empty
  >;
  getClient: grpc.handleUnaryCall<
    drite_account_v1_client_pb.GetClientRequest,
    drite_account_v1_client_pb.Client
  >;
  getJwks: grpc.handleUnaryCall<
    drite_account_v1_jwk_pb.GetJwksRequest,
    google_protobuf_any_pb.Any
  >;
  getUser: grpc.handleUnaryCall<
    ...
    drite_account_v1_user_pb.User
  >;
  listClients: grpc.handleUnaryCall<
    drite_account_v1_client_pb.ListClientsRequest,
    drite_account_v1_client_pb.ListClientsResponse
  >;
...
export interface IAccountServiceClient {
  authenticateUser(
    request: drite_account_v1_user_pb.AuthenticateUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_user_pb.AuthenticateUserResponse
    ) => void
  ...
  createClient(
    request: drite_account_v1_client_pb.CreateClientRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_client_pb.Client
    ) => void
  ): grpc.ClientUnaryCall;
  createClient(
    request: drite_account_v1_client_pb.CreateClientRequest,
  ...
  createUser(
    request: drite_account_v1_user_pb.CreateUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_user_pb.User
    ) => void
  ): grpc.ClientUnaryCall;
  createUser(
    request: drite_account_v1_user_pb.CreateUserRequest,
  ...
  deleteClient(
    request: drite_account_v1_client_pb.DeleteClientRequest,
    callback: (
      error: grpc.ServiceError | null,
  ...
  deleteUser(
    request: drite_account_v1_user_pb.DeleteUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: google_protobuf_empty_pb.Empty
    ) => void
  ...
  getClient(
    request: drite_account_v1_client_pb.GetClientRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_client_pb.Client
    ) => void
  ...
  getJwks(
    request: drite_account_v1_jwk_pb.GetJwksRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: google_protobuf_any_pb.Any
    ) => void
  ): grpc.ClientUnaryCall;
  getJwks(
    request: drite_account_v1_jwk_pb.GetJwksRequest,
  ...
  getUser(
    request: drite_account_v1_user_pb.GetUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_user_pb.User
    ) => void
  ...
  listClients(
    request: drite_account_v1_client_pb.ListClientsRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_client_pb.ListClientsResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listClients(
    request: drite_account_v1_client_pb.ListClientsRequest,
  ...
  listUsers(
    request: drite_account_v1_user_pb.ListUsersRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_user_pb.ListUsersResponse
    ) => void
  ): grpc.ClientUnaryCall;
  listUsers(
    request: drite_account_v1_user_pb.ListUsersRequest,
  ...
  updateUser(
    request: drite_account_v1_user_pb.UpdateUserRequest,
    callback: (
      error: grpc.ServiceError | null,
      response: drite_account_v1_user_pb.User
    ) => void
...
export class AccountServiceClient
  extends grpc.Client
  implements IAccountServiceClient
{
  constructor(
    address: string,
