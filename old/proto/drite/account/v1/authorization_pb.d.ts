...
import * as drite_account_v1_code_challenge_method_pb from "./code_challenge_method_pb";
import * as drite_account_v1_scope_pb from "./scope_pb";
...
export class AuthorizationRequest extends jspb.Message {
  ...
  getCodeChallengeMethod():
    | drite_account_v1_code_challenge_method_pb.CodeChallengeMethod
    | undefined;
  setCodeChallengeMethod(
    value: drite_account_v1_code_challenge_method_pb.CodeChallengeMethod
...
export class AuthorizationResponse extends jspb.Message {
  ...
  setClient(value?: drite_account_v1_client_pb.Client): AuthorizationResponse;
  clearScopesList(): void;
  getScopesList(): Array<drite_account_v1_scope_pb.Scope>;
  setScopesList(
    value: Array<drite_account_v1_scope_pb.Scope>
  ): AuthorizationResponse;
  addScopes(
    value?: drite_account_v1_scope_pb.Scope,
    index?: number
  ): drite_account_v1_scope_pb.Scope;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): AuthorizationResponse.AsObject;
  static toObject(
    includeInstance: boolean,
    msg: AuthorizationResponse
  ): AuthorizationResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class CreateAuthorizationRequest extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CreateAuthorizationRequest
  ): CreateAuthorizationRequest.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
...
export class CreateAuthorizationResponse extends jspb.Message {
  ...
  static toObject(
    includeInstance: boolean,
    msg: CreateAuthorizationResponse
  ): CreateAuthorizationResponse.AsObject;
  static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
  static extensionsBinary: {
    [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
  };
