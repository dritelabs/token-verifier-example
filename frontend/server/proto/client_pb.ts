...
// @generated from file client.proto (package pb, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message pb.Client
 */
export class Client extends Message<Client> {
  ...
  /**
   * @generated from field: repeated pb.GrantType grant_types = 6;
   */
  ...
  /**
   * @generated from field: pb.PublicKeysConfiguration public_keys_configuration = 13;
   */
  publicKeysConfiguration = PublicKeysConfiguration.LOCAL;
  ...
  /**
   * @generated from field: pb.RefreshTokenRotationType refresh_token_rotation_type = 15;
   */
  refreshTokenRotationType = RefreshTokenRotationType.ROTATE;

  /**
   * @generated from field: repeated pb.ResponseType response_types = 16;
   */
  ...
  /**
   * @generated from field: pb.ApplicationType type = 21;
   */
  ...
  /**
   * @generated from field: pb.TokenEndpointAuthMethod token_endpoint_auth_method = 23;
   */
  ...
  static readonly typeName = "pb.Client";
...
/**
 * @generated from message pb.ClientsResponse
 */
export class ClientsResponse extends Message<ClientsResponse> {
  /**
   * @generated from field: repeated pb.Client clients = 1;
   */
  clients: Client[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.ClientsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message pb.CreateClientRequest
 */
export class CreateClientRequest extends Message<CreateClientRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.CreateClientRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 5, name: "description", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 11, name: "name", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 14, name: "redirect_uris", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
...
/**
 * @generated from message pb.DeleteClientRequest
 */
export class DeleteClientRequest extends Message<DeleteClientRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.DeleteClientRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message pb.GetClientRequest
 */
export class GetClientRequest extends Message<GetClientRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.GetClientRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
  ]);
...
/**
 * @generated from message pb.ListClientsRequest
 */
export class ListClientsRequest extends Message<ListClientsRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.ListClientsRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message pb.ListClientsResponse
 */
export class ListClientsResponse extends Message<ListClientsResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.ListClientsResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "clients", kind: "message", T: Client, repeated: true },
  ]);
...
/**
 * @generated from message pb.UpdateClientRequest
 */
export class UpdateClientRequest extends Message<UpdateClientRequest> {
  ...
  /**
   * @generated from field: optional pb.PublicKeysConfiguration public_keys_configuration = 13;
   */
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.UpdateClientRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 3, name: "contacts", kind: "scalar", T: 9 /* ScalarType.STRING */, repeated: true },
