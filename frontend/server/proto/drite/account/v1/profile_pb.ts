...
// @generated from file drite/account/v1/profile.proto (package drite.account.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message drite.account.v1.Profile
 */
export class Profile extends Message<Profile> {
  ...
  /**
   * @generated from field: drite.account.v1.Gender gender = 4;
   */
  ...
  static readonly typeName = "drite.account.v1.Profile";
...
/**
 * @generated from message drite.account.v1.UpdateProfileRequest
 */
export class UpdateProfileRequest extends Message<UpdateProfileRequest> {
  ...
  /**
   * @generated from field: optional drite.account.v1.Gender gender = 4;
   */
  gender?: Gender;
  ...
  static readonly runtime = proto3;
  static readonly typeName = "drite.account.v1.UpdateProfileRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
