...
// @generated from file drite/account/v1/authorization.proto (package drite.account.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message drite.account.v1.AuthorizationRequest
 */
export class AuthorizationRequest extends Message<AuthorizationRequest> {
  ...
  /**
   * @generated from field: optional drite.account.v1.CodeChallengeMethod code_challenge_method = 3;
   */
  ...
  static readonly typeName = "drite.account.v1.AuthorizationRequest";
...
/**
 * @generated from message drite.account.v1.AuthorizationResponse
 */
export class AuthorizationResponse extends Message<AuthorizationResponse> {
  ...
  /**
   * @generated from field: repeated drite.account.v1.Scope scopes = 2;
   */
  scopes: Scope[] = [];
  ...
  static readonly runtime = proto3;
  static readonly typeName = "drite.account.v1.AuthorizationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message drite.account.v1.CreateAuthorizationRequest
 */
export class CreateAuthorizationRequest extends Message<CreateAuthorizationRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "drite.account.v1.CreateAuthorizationRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "client_id", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "code_challenge", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 3, name: "code_challenge_method", kind: "enum", T: proto3.getEnumType(CodeChallengeMethod), opt: true },
...
/**
 * @generated from message drite.account.v1.CreateAuthorizationResponse
 */
export class CreateAuthorizationResponse extends Message<CreateAuthorizationResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "drite.account.v1.CreateAuthorizationResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
