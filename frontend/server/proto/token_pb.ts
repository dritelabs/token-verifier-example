...
// @generated from file token.proto (package pb, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message pb.TokenRequest
 */
export class TokenRequest extends Message<TokenRequest> {
  ...
  /**
   * @generated from field: pb.GrantType grant_type = 3;
   */
  grantType = GrantType.AUTHORIZATION_CODE;

  /**
   * @generated from oneof pb.TokenRequest.grant_type_request
   */
  grantTypeRequest: {
    /**
     * @generated from field: pb.TokenRequest.AuthorizationCodeGrant authorization_code_grant = 4;
     */
    value: TokenRequest_AuthorizationCodeGrant;
    case: "authorizationCodeGrant";
  } | {
    /**
     * @generated from field: pb.TokenRequest.ClientCredentialsGrant client_credentials_grant = 5;
     */
    value: TokenRequest_ClientCredentialsGrant;
    case: "clientCredentialsGrant";
  } | {
    /**
     * @generated from field: pb.TokenRequest.RefreshTokenGrant refresh_token_grant = 6;
     */
  ...
  static readonly typeName = "pb.TokenRequest";
...
/**
 * @generated from message pb.TokenRequest.AuthorizationCodeGrant
 */
export class TokenRequest_AuthorizationCodeGrant extends Message<TokenRequest_AuthorizationCodeGrant> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.TokenRequest.AuthorizationCodeGrant";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message pb.TokenRequest.ClientCredentialsGrant
 */
export class TokenRequest_ClientCredentialsGrant extends Message<TokenRequest_ClientCredentialsGrant> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.TokenRequest.ClientCredentialsGrant";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
  ]);
...
/**
 * @generated from message pb.TokenRequest.RefreshTokenGrant
 */
export class TokenRequest_RefreshTokenGrant extends Message<TokenRequest_RefreshTokenGrant> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.TokenRequest.RefreshTokenGrant";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message pb.TokenResponse
 */
export class TokenResponse extends Message<TokenResponse> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "pb.TokenResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
