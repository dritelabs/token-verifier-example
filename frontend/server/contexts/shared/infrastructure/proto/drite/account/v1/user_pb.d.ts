...
import * as drite_account_v1_profile_pb from "../../../drite/account/v1/profile_pb";
...
export class User extends jspb.Message { 
    ...
    addClients(value?: drite_account_v1_client_pb.Client, index?: number): drite_account_v1_client_pb.Client;
    clearClientApprovalsList(): void;
    getClientApprovalsList(): Array<drite_account_v1_client_approval_pb.ClientApproval>;
    setClientApprovalsList(value: Array<drite_account_v1_client_approval_pb.ClientApproval>): User;
...
export class UpdateUserRequest extends jspb.Message { 
    ...
    setProfile(value?: drite_account_v1_profile_pb.UpdateProfileRequest): UpdateUserRequest;
