...
import * as drite_account_v1_application_type_pb from "../../../drite/account/v1/application_type_pb";
import * as drite_account_v1_client_approval_pb from "../../../drite/account/v1/client_approval_pb";
import * as drite_account_v1_grant_type_pb from "../../../drite/account/v1/grant_type_pb";
import * as drite_account_v1_public_keys_configuration_pb from "../../../drite/account/v1/public_keys_configuration_pb";
import * as drite_account_v1_refresh_token_rotation_type_pb from "../../../drite/account/v1/refresh_token_rotation_type_pb";
import * as drite_account_v1_response_type_pb from "../../../drite/account/v1/response_type_pb";
import * as drite_account_v1_token_endpoint_auth_method_pb from "../../../drite/account/v1/token_endpoint_auth_method_pb";
...
export class Client extends jspb.Message { 
    ...
    setClientApprovalsList(value: Array<drite_account_v1_client_approval_pb.ClientApproval>): Client;
    addClientApprovals(value?: drite_account_v1_client_approval_pb.ClientApproval, index?: number): drite_account_v1_client_approval_pb.ClientApproval;
    ...
    setGrantTypesList(value: Array<drite_account_v1_grant_type_pb.GrantType>): Client;
    addGrantTypes(value: drite_account_v1_grant_type_pb.GrantType, index?: number): drite_account_v1_grant_type_pb.GrantType;
    ...
    setPublicKeysConfiguration(value: drite_account_v1_public_keys_configuration_pb.PublicKeysConfiguration): Client;
    ...
    setRefreshTokenRotationType(value: drite_account_v1_refresh_token_rotation_type_pb.RefreshTokenRotationType): Client;
    clearResponseTypesList(): void;
    getResponseTypesList(): Array<drite_account_v1_response_type_pb.ResponseType>;
    setResponseTypesList(value: Array<drite_account_v1_response_type_pb.ResponseType>): Client;
    addResponseTypes(value: drite_account_v1_response_type_pb.ResponseType, index?: number): drite_account_v1_response_type_pb.ResponseType;
    getSecret(): string;
    ...
    setTokenEndpointAuthMethod(value: drite_account_v1_token_endpoint_auth_method_pb.TokenEndpointAuthMethod): Client;
    getUri(): string;
...
export class CreateClientRequest extends jspb.Message { 
    ...
    addRedirectUris(value: string, index?: number): string;
    getType(): drite_account_v1_application_type_pb.ApplicationType;
    setType(value: drite_account_v1_application_type_pb.ApplicationType): CreateClientRequest;
...
export class UpdateClientRequest extends jspb.Message { 
    ...
    clearGrantTypesList(): void;
    getGrantTypesList(): Array<drite_account_v1_grant_type_pb.GrantType>;
    setGrantTypesList(value: Array<drite_account_v1_grant_type_pb.GrantType>): UpdateClientRequest;
    addGrantTypes(value: drite_account_v1_grant_type_pb.GrantType, index?: number): drite_account_v1_grant_type_pb.GrantType;
    ...
    getPublicKeysConfiguration(): drite_account_v1_public_keys_configuration_pb.PublicKeysConfiguration | undefined;
    setPublicKeysConfiguration(value: drite_account_v1_public_keys_configuration_pb.PublicKeysConfiguration): UpdateClientRequest;
    clearRedirectUrisList(): void;
    getRedirectUrisList(): Array<string>;
    setRedirectUrisList(value: Array<string>): UpdateClientRequest;
    addRedirectUris(value: string, index?: number): string;
    getRefreshTokenRotationType(): drite_account_v1_refresh_token_rotation_type_pb.RefreshTokenRotationType;
    setRefreshTokenRotationType(value: drite_account_v1_refresh_token_rotation_type_pb.RefreshTokenRotationType): UpdateClientRequest;
    clearResponseTypesList(): void;
    getResponseTypesList(): Array<drite_account_v1_response_type_pb.ResponseType>;
    setResponseTypesList(value: Array<drite_account_v1_response_type_pb.ResponseType>): UpdateClientRequest;
    addResponseTypes(value: drite_account_v1_response_type_pb.ResponseType, index?: number): drite_account_v1_response_type_pb.ResponseType;
    ...
    getType(): drite_account_v1_application_type_pb.ApplicationType;
    setType(value: drite_account_v1_application_type_pb.ApplicationType): UpdateClientRequest;
    ...
    getTokenEndpointAuthMethod(): drite_account_v1_token_endpoint_auth_method_pb.TokenEndpointAuthMethod;
    setTokenEndpointAuthMethod(value: drite_account_v1_token_endpoint_auth_method_pb.TokenEndpointAuthMethod): UpdateClientRequest;
