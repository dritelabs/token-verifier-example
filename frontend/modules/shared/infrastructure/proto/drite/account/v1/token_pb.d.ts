...
// file: drite/account/v1/token.proto
...
export class TokenRequest extends jspb.Message {
  ...
  getGrantType(): drite_account_v1_grant_type_pb.GrantType;
  setGrantType(value: drite_account_v1_grant_type_pb.GrantType): TokenRequest;
  ...
  setAuthorizationCodeGrant(
    value?: TokenRequest.AuthorizationCodeGrant
  ): TokenRequest;
  ...
  setClientCredentialsGrant(
    value?: TokenRequest.ClientCredentialsGrant
  ): TokenRequest;
...
export namespace TokenRequest {
  export type AsObject = {
    clientId: string;
    scope: string;
    grantType: drite_account_v1_grant_type_pb.GrantType;
  ...
  export class AuthorizationCodeGrant extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: AuthorizationCodeGrant
    ): AuthorizationCodeGrant.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class ClientCredentialsGrant extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: ClientCredentialsGrant
    ): ClientCredentialsGrant.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
  ...
  export class RefreshTokenGrant extends jspb.Message {
    ...
    static toObject(
      includeInstance: boolean,
      msg: RefreshTokenGrant
    ): RefreshTokenGrant.AsObject;
    static extensions: { [key: number]: jspb.ExtensionFieldInfo<jspb.Message> };
    static extensionsBinary: {
      [key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>;
    };
